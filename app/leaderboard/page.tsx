...
export default async function LeaderboardPage() {
  ...
  // Get fastest lap per rider (global)
  ...
  // Deduplicate by user — keep fastest per rider
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <p className="text-text-muted text-sm mb-8">Fastest riders across all tracks</p>
